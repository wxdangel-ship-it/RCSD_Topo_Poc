...
def test_step6_builds_segment_inner_nodes_and_error_outputs(tmp_path: Path) -> None:
    ...
    write_geojson(
        road_path,
        [
            _road_feature("r1", 1, 2, [(0.0, 0.0), (1.0, 0.0)], s_grade="0-1双", segmentid="1_4"),
            _road_feature("r2", 2, 3, [(1.0, 0.0), (2.0, 0.0)], s_grade="0-1双", segmentid="1_4", multiline=True),
            _road_feature("r3", 3, 4, [(2.0, 0.0), (3.0, 0.0)], s_grade="0-1双", segmentid="1_4"),
...
def test_step6_fails_when_segment_contains_multiple_s_grades(tmp_path: Path) -> None:
    ...
    write_geojson(
        road_path,
        [
            _road_feature("r1", 1, 2, [(0.0, 0.0), (1.0, 0.0)], s_grade="0-1双", segmentid="1_3"),
            _road_feature("r2", 2, 3, [(1.0, 0.0), (2.0, 0.0)], s_grade="0-0双", segmentid="1_3"),
        ],
    )
