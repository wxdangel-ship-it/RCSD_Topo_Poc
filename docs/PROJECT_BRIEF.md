...
- `p01_arm_build` 当前作为 Active POC 验证模块进入治理；正式范围覆盖 P01-A1 Arm 构建与 P01-A2 Arm 配准，输出 Trace / ThroughDecisionAudit / IssueReport / LogicalArmGroup / RawArmAlignment / ArmBuildFeedback / review PNG / review GPKG / summary / review index，当前不新增 repo 官方 CLI 或 `scripts/` 常驻脚本
