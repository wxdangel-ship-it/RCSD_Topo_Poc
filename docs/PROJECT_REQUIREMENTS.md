...
- T07 处理已有路口面 / RCSDIntersection 能直接说明关系的路口，并在 T05 relation 之后补齐部分无路口面特征的锚定。
...
- T03/T04/T05/T07 surface 可以帮助节点语义闭合，但不能绕过 T04 reject、Patch 冲突、多候选冲突或 Step2 replacement plan。
...
| T07 | 已有路口面 1:1 锚定与 T05 relation 补锚，不处理 Segment，不生成虚拟路口面。 |
