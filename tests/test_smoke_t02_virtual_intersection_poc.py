...
def test_smoke_t02_virtual_intersection_poc() -> None:
    ...
    roads_path = inputs_dir / "roads.geojson"
    drivezone_path = inputs_dir / "drivezone.geojson"
    rcsdroad_path = inputs_dir / "rcsdroad.geojson"
    rcsdnode_path = inputs_dir / "rcsdnode.geojson"
    ...
    assert (run_dir / "virtual_intersection_polygon.geojson").is_file()
    assert (run_dir / "branch_evidence.json").is_file()
    assert (run_dir / "branch_evidence.geojson").is_file()
    assert (run_dir / "associated_rcsdroad.geojson").is_file()
    assert (run_dir / "associated_rcsdnode.geojson").is_file()
