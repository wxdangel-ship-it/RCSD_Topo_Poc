...
def test_pair_relations_are_required_and_junc_relations_are_optional() -> None:
...
def test_relation_mapping_reports_optional_junc_failures_without_rejecting_segment() -> None:
