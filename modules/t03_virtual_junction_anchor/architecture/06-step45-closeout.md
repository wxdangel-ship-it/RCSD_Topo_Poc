...
- environment:
  ...
  - out_root: `/mnt/e/Work/RCSD_Topo_Poc/outputs/_work/t03_step45_joint_phase`
...
- association / reason distribution:
  - `step45_established = 25`
  - `step45_support_only = 30`
  - `step45_no_related_rcsd = 3`
...
Reference files:
- `outputs/_work/t03_step45_joint_phase/20260418_t03_step45_joint_phase_v004/preflight.json`
- `outputs/_work/t03_step45_joint_phase/20260418_t03_step45_joint_phase_v004/summary.json`
- `outputs/_work/t03_step45_joint_phase/20260418_t03_step45_joint_phase_v004/step45_review_index.csv`
...
- `step45_audit.json` 已将 `nonsemantic_connector_rcsdnode_ids` 与 `true_foreign_rcsdnode_ids` 分开，供 `Step6` 继续精化
