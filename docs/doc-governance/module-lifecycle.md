...
| `t10_e2e_orchestration` | `Active` | `modules/t10_e2e_orchestration` | 端到端业务流程编排与 Case 证据组织模块；v1 编排 T01 / T07 / T03 / T04 / T05 / T06 / T09，T08 独立运行。 |
...
- T10 已启动为 Active 正式模块，当前仍处于 contract validation 与 manifest-first Case 包阶段。
