...
COMPAT_TOP_LEVEL_KEYS = [
    ...
    "special_junction_internal_rcsd_road_count",
    "special_junction_internal_rcsd_road_used_count",
    "reality_change_rcsd_road_count",
    "unresolved_exception_rcsd_road_count",
    "ownership_duplicate_count",
    "ownership_missing_count",
    "final_rcsd_road_single_segment_assignment_count",
    "final_rcsd_road_unassigned_count",
    "final_rcsd_road_multi_segment_assignment_count",
