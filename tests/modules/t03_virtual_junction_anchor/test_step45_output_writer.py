...
def test_step45_output_writer_keeps_flat_dir_flat_and_summary_stable(tmp_path: Path) -> None:
    ...
    assert summary_doc["step45_established_count"] == 1
    assert summary_doc["step45_review_count"] == 0
    assert summary_doc["step45_not_established_count"] == 0
