...
HANDOFF_REQUIREMENTS: tuple[ArtifactRequirement, ...] = (
    ...
    ArtifactRequirement("t07_nodes", "t07_semantic_junction_anchor", "T07 Step2/Step3 nodes.gpkg."),
...
WORKFLOW_STEPS: tuple[WorkflowStepSpec, ...] = (
    ...
    WorkflowStepSpec(
        ...
        produces=("t03_surface", "t03_relation_evidence", "t03_intersection_match"),
    ),
    WorkflowStepSpec(
        "t04",
        "t04_divmerge_virtual_polygon",
        consumes=("t07_nodes", "prepared_swsd_roads", "drivezone", "divstripzone", "rcsdroad", "rcsdnode"),
        produces=("t04_surface", "t04_relation_evidence", "t04_intersection_match"),
    ),
    WorkflowStepSpec(
        "t05",
        "t05_junction_surface_fusion",
