...
from .step3_topology_supplement_support import (
    _attachment_nodes_by_swsd_road_endpoint,
    _replacement_segment_ids_by_swsd_road,
    _mapped_rcsd_node_id,
    _topology_supplement_road,
    _line_with_snapped_endpoints,
    _coord_with_xy,
    _road_endpoint_node_ids,
    _road_segment_ids,
    _is_formal_unit_body_swsd_road,
    _incident_segment_ids_by_node,
    _is_mixed_advance_right_carrier,
    _can_use_existing_rcsd_advance_group_for_replaced_carrier,
    _touches_detached_node,
    _feature_line,
    _is_advance_right_road,
    _is_existing_rcsd_advance_candidate,
    _is_side_attachment_swsd_road,
    _node_point,
    _next_generated_road_id,
    _safe_id,
    _safe_surface_id,
    _safe_id_list,
)
    ...
    return cached_corridor_coverage_decision(
        ...
        compute=lambda: coverage_failed_after_junction_surface_release(
            ...
            cached_buffered_road_corridor(
                road_geometries=geometries,
                buffer_m=buffer_m,
                compute=lambda: unary_union(geometries).buffer(buffer_m),
            ),
