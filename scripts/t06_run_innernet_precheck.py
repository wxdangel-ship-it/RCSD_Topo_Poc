        ...
        json.dumps(
            {
                ...
                "step1": {
                    ...
                    "segment_stats": str(artifacts.step1.stats_csv_path),
                ...
                "step2": {
                    ...
                    "replacement_plan": str(artifacts.step2.replacement_plan_gpkg_path) if artifacts.step2.replacement_plan_gpkg_path else None,
                    "problem_registry": str(artifacts.step2.problem_registry_gpkg_path) if artifacts.step2.problem_registry_gpkg_path else None,
