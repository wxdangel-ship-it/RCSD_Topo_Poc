    ...
    for event_unit in case_result.event_units:
        ...
        write_json(
            event_unit_dir / "step4_candidates.json",
            {
                ...
                "rcsd_conflict_type": event_unit.rcsd_conflict_type,
                "conflict_resolution_action": event_unit.conflict_resolution_action,
                "pre_resolution_candidate_id": event_unit.pre_resolution_candidate_id,
                "post_resolution_candidate_id": event_unit.post_resolution_candidate_id,
                "pre_required_rcsd_node": event_unit.pre_required_rcsd_node,
