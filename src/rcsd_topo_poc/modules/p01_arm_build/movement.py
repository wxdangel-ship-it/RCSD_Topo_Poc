    ...
    *,
    ...
    for arm in final_arms:
        ...
        payload = {
            ...
            "validation_status": arm.validation_status,
            "validation_id": arm.validation_id,
            "validation_confidence": arm.validation_confidence,
            "validation_risk_flags": list(arm.validation_risk_flags),
