...
| `t08_tool4_junction_type_repair.py` | `scripts/t08_tool4_junction_type_repair.py` | repo 级 | T08 Tool4 路口类型错误识别，校验 `kind=2048 / 4 / 16+8` 语义路口类型并输出 `nodes_error.gpkg` 与 summary，不改写输入 Nodes/Roads | `active` | 否 |
