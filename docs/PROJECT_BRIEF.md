...
- 基础测试与 smoke 模式
- 已登记正式模块的文档契约与实现收口
- 已登记正式模块的 stage1、stage2、stage3 baseline 与支撑入口边界对齐
...
- 对齐 `t02_junction_anchor` 当前已存在的 stage1、stage2、stage3 baseline 与支撑入口
...
- `t02_junction_anchor` 当前已具备 stage1、stage2、stage3 `virtual intersection anchoring` baseline 的最小实现闭环
