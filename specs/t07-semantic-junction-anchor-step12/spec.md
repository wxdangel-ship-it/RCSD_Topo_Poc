...
- **FR-024**: T07 Step3 MUST output `t07_swsd_rcsd_relation_evidence.csv/json` by merging Step2 evidence with successful `intersection_match_tool7.geojson` backfill rows, and MUST expose Step2 / Step3 anchor counts.
