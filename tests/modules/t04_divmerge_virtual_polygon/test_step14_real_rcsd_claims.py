...
def test_real_case_17943587_second_pass_resolves_duplicate_required_rcsd_node_without_evidence_regression() -> None:
    ...
    assert units["node_17943587"].selected_evidence_summary["candidate_id"] == "node_17943587:divstrip:2:01"
    assert units["node_55353233"].selected_evidence_summary["candidate_id"] == "node_55353233:divstrip:2:01"
    assert units["node_55353239"].selected_evidence_summary["candidate_id"] == "node_55353239:divstrip:2:01"
    assert units["node_55353248"].selected_evidence_summary["candidate_id"] == "node_55353248:divstrip:2:01"
    ...
    assert required_by_unit["node_55353233"] == "5381293925340552"
    assert required_by_unit["node_55353239"] == "5381293925340519"
    assert required_by_unit["node_55353248"] == "5381293925340546"

    assert units["node_55353233"].pre_required_rcsd_node == "5381293925340546"
    assert units["node_55353233"].post_required_rcsd_node == "5381293925340552"
    assert units["node_55353233"].conflict_resolution_action == "reassigned_required_rcsd_node"
    ...
    assert units["node_55353248"].post_required_rcsd_node == "5381293925340546"
...
def test_real_case_760213_same_case_non_conflict_units_remain_frozen_after_second_pass() -> None:
    ...
    assert units["node_760213"].selected_evidence_summary["candidate_id"] == "node_760213:divstrip:3:01"
    assert units["node_760218"].selected_evidence_summary["candidate_id"] == "node_760218:divstrip:3:01"
