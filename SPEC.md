...
T10 v1 Case runner 编排 `T01 -> T07 Step1/2 -> T03 -> T04 -> T05 -> T06 -> T09`。T08 是独立前置预处理、质检和修复模块，不由 Case runner 调用；内网全量总控可把 T08 作为独立阶段串入全量链路。T07 Step3 是可选兼容 relation 补锚，不是 T10 默认主链阶段。
