...
T05 Phase 1 + Phase 2 内网联合实验提供 repo 级入口。该入口把 T02/T03/T04 成果目录、原始 RCSDRoad/RCSDNode、final nodes 与 RCSDIntersection 作为参数，先执行 T03 evidence handoff 补齐，再执行 Phase 1 surface fusion 与 Phase 2 relation 发布：
