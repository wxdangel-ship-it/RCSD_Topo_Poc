...
T10 消费外部输入、T01-T09 模块输出、T06 problem registry、T06 relation audit、Case package、Segment package 和已有 full pipeline run root。T10 输出 workflow plan、handoff audit、Case / Segment evidence package、Case replay manifest、T06 funnel、feedback package、visual check summary 和 full pipeline manifest / summary。
