...
T10 面向 RCSD_Topo 端到端业务流程编排与 Case 级证据组织。项目级主业务链仍保持 `T08 -> T01 -> T07 -> T03 -> T04 -> T05 -> T06 -> T09`；T10 v1 的局部编排范围为 `T01 -> T07 Step1/2 -> T03 -> T04 -> T05 -> T07 Step3 -> T06 -> T09`，T08 作为独立前置预处理、质检与修复模块，不由 T10 v1 调用。
