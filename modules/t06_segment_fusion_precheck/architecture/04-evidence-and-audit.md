...
| `t06_step3_unreplaced_rcsd_attribution.*` | 未替换 RCSDRoad 反向归因审计。按 `5 > 4 > 3 > 2 > 1 > 6` 优先级，把每条未替换 RCSDRoad 映射到可替换但未落地、Relation 后不可替换、有证据但 Relation 不完整、SWSD 范围内但无 T06 证据、SWSD 范围外和未归因六类，并保留命中的 Segment 与上游拒绝原因。 |
